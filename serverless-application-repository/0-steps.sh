...
aws s3api put-bucket-policy --bucket aws-sam-cli-managed-default-samclisourcebucket-nfezxzbpgu80 --policy file://policy.json
...
sam package --template-file template.yaml --output-template-file packaged.yaml --s3-bucket ap-sar-demo-2023
